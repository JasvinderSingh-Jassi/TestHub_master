...
it("Print and assert all resturant with free Delivery shown",() =>{
    ...
    util.alltextMatch(Grubhub_Page.free_delivery_assert,'Free delivery');
...
fit("Print and assert all the restaurant with less than 45 min is shown",() =>{
    ...
    util.toBeLessalltextMatch(Grubhub_Page.lessTime,'45');
...
it("Assert and print Catering Section",() =>{
   ...
   // util.wait(HigherPrice);
    ...
    if(Grubhub_Page.Choice_checkbox.isPresent() ){
    ...
    //Select your choice
     ...
     else if(Grubhub_Page.Choice.isPresent() ){
