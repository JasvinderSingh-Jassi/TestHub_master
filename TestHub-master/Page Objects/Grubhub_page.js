...
this.free_delivery_assert= element.all(by.css("[data-testid='text-delivery-fee']"));
...
//this.popup1=element(by.css('.c-modal-body-section')).element(by.tagName('a'));
...
this.Print_rating= element.all(by.css("[data-testid='starRating']"));
